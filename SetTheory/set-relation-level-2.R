...
#                     sets, correct, and incorrect
#                     answers.
get_asym_diff_level_2 <- function(numSets=2, setSize=5, dType = 1) {
...
#                        answers.
#
get_set_complement_level_2 <- function(numSets = 2, setSize = 9, dType = 1) {
...
get_set_equality_level_2 <- function(numSets = 2, setSize = 5, dType = 1) {
...
#                        answers.
#
get_set_cardinality_level_2 <- function(numSets = 1, setSize = sample(1:9, 1, replace = FALSE), dType = 1) {
  #define the text of the question
...
get_symm_diff_level_2 <- function(numSets = 2, setSize = 5, dType = 1){
...
get_set_partitions_level_2 <- function(numSets = 1, setSize = 5, dType = 1) {
...
#
get_power_set_level_2 <- function(numSets = 1, setSize = 3, dType = 6) {
  ...
  if (question_type == 1) {
    ...
    # represented as a list.
    for (i in (1:3)) {
      currentDist <- power_set_distractor_bank(
          qa_level = qa_level,
          question_type = question_type,
          distractor_type = i,
          distractor_style = sample(1:2, 1),
          source_set_1 = a,
          setSize = setSize,
          dType = dType
        )
...
#                               distractors (incorrect answers)
#  
get_cartesian_product_level_2 <- function(numSets = 2, setSize = 3, dType = 1) {
  ...
  if (question_type == 1) {
    ...
    question <- cartseian_product_question_bank(
        qa_level = 2,
        question_type = question_type,
    ...
    for(i in  (1:3) ) {
      ...
      current_distractor_list <- cartseian_product_distractor_bank(
          qa_level = 2,
          distractor_type = i,
          source_set_1 =  a,
          source_set_2 =  b,
