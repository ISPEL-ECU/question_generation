...
#todos for trevor's code

#needs to be able to generates image for 2-3 sets for each operations
#show different operations indicated by the grammars in the set expressions generator 
#have the ability to shade area in the front area so converting png to base64enc
#be in a api send json format  
#be able to used as a package. 
